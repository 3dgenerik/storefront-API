...
describe('Testing dashboard routes: ', () => {
    ...
    describe('Testing get most popular products', () => {
        fit(`GET: ${"/api" /* AppRoutePath.PREFIX_ROUTE */}${"/products" /* AppRoutePath.ENDPOINT_PRODUCTS */}/popular`, () => __awaiter(void 0, void 0, void 0, function* () {
            const result = yield request
                .get(`${"/api" /* AppRoutePath.PREFIX_ROUTE */}${"/products" /* AppRoutePath.ENDPOINT_PRODUCTS */}/popular`);
            const popularProductsList = yield result.body;
            console.log(popularProductsList);
