...
let GetAllOrdersByUserIdController = 
    ...
    getAllOrdersByUserId(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const allOrders = yield store.getAllOrdersByUserId(Number(userId));
                if (allOrders.length === 0)
                    throw new customError_1.CustomError(`Orders list is empty.`, 200);
...
__decorate([
    (0, decorators_1.get)(`${"/users" /* AppRoutePath.ENDPOINT_USERS */}/:userId${"/orders" /* AppRoutePath.ENDPOINT_ORDERS */}`),
    (0, decorators_1.middleware)((0, idParamValidatorMiddleware_1.idParamValidatorMiddleware)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Function]),
    __metadata("design:returntype", Promise)
], GetAllOrdersByUserIdController.prototype, "getAllOrdersByUserId", null);
GetAllOrdersByUserIdController = __decorate([
